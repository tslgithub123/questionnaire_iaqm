...
@Entity
@Table(name = "ParticipantSmall")
public class ParticipantSmall {
	...
	private String childPastSymptomsAllergicRunnyNose;
		...
		public ParticipantSmall(Long healthId, String participantId, String locationId, String placeOfDataCollection,
				...
				String childPastSymptomsAllergicRunnyNose, int heightCm, int weightKg, int pulseBpm, int spO2Percent,
				int peakFlowMeterReading1, int peakFlowMeterReading2, int peakFlowMeterReading3,
				String lungOscillometry) {
			super();
			this.healthId = healthId;
			this.participantId = participantId;
			this.locationId = locationId;
		...
		public String toString() {
			return "Participant [healthId=" + healthId + ", participantId=" + participantId + ", locationId="
					...
					+ getWeightKg() + ", getPulseBpm()=" + getPulseBpm() + ", getSpO2Percent()=" + getSpO2Percent()
					+ ", getPeakFlowMeterReading1()=" + getPeakFlowMeterReading1() + ", getPeakFlowMeterReading2()="
					+ getPeakFlowMeterReading2() + ", getPeakFlowMeterReading3()=" + getPeakFlowMeterReading3()
					+ ", getLungOscillometry()=" + getLungOscillometry() + ", getClass()=" + getClass()
